...
<script src="/web/<?php echo $_PETICION->modulo; ?>/js/catalogos/orden_compra/edicion_articulos.js"></script>
<script src="/web/<?php echo $_PETICION->modulo; ?>/js/catalogos/orden_compra/edicion_orden_compra.js"></script>
